...
win.innerHTML = `<div id="oj-chat-header"> <div class="oj-avatar"><img src="brand_assets/logo.png" style="width:32px;height:32px;object-fit:contain;border-radius:50%;" /></div> <div> <div class="oj-title">Overtime Junkers</div> <div class="oj-subtitle">Typically replies in minutes</div> </div> <button id="oj-close-btn">✕</button> </div> <div id="oj-messages"></div> <div id="oj-input-area"> <input id="oj-input" type="text" placeholder="Type a message…" autocomplete="off" /> <button id="oj-send-btn" aria-label="Send"> <svg viewBox="0 0 24 24"><path d="M2.01 21L23 12 2.01 3 2 10l15 2-15 2z"/></svg> </button> </div>`;
...
1. Their location (city or neighborhood in the Houston area)
1. Their first name
